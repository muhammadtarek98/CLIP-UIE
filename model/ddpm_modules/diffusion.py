...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        self.L_clip=clip_score.L_clip_from_feature()#clip-enhanced
        self.L_clip_MSE=clip_score.L_clip_MSE()#identity loss
        self.text_features=clip_score.load_learned_prompt(path='/data/liusx/Pycharm/CLIP-LIT-main/train0/snapshots_prompt_train0/iter_100000.pth')
